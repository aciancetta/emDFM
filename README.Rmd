...
```{r forecast_pipeline, eval = FALSE}
# Plot forecasts
forecast_input <- list(
            estimator = "EM",
            variable = "indpro_SCA",
...
# Credits
This package has been developed during my internship at [IRPET](http://www.irpet.it/) (Regional Institute for Economic Planning of Tuscany).
